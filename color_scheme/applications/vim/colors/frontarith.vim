...
call <SID>fHi("DiffText",     s:cgFg, s:cgBf, s:ctFg, s:ctBf, "bold")
call <SID>fHi("EndOfBuffer",  s:cgFG, s:cgBG, s:ctFG, s:ctBG, "")
call <SID>fHi("ErrorMsg",     s:cgF1, s:cgBg, s:ctF1, s:ctBg, "")
...
call <SID>fHi("WarningMsg",   s:cgF2, s:cgBg, s:ctF2, s:ctBg, "")
