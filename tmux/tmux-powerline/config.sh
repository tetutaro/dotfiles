...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/1m/yrwfq8js7fb_vrvhbhjq_wpr0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX=""
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC=""
# }
